...
const cancelBidBuilder = (params) => {
    ...
    const tokenAccount = isPublic
        ? (0, tokenModule_1.findAssociatedTokenAccountPda)(asset.mint.address, (0, types_1.toPublicKey)(bid.buyerAddress))
    ...
    if (auctioneerAuthority) {
        cancelBidInstruction = (0, mpl_auction_house_1.createAuctioneerCancelInstruction)(Object.assign(Object.assign({}, accounts), { auctioneerAuthority: auctioneerAuthority.publicKey, ahAuctioneerPda: (0, pdas_1.findAuctioneerPda)(auctionHouse.address, auctioneerAuthority.publicKey) }), args);
    }
    // Signers.
