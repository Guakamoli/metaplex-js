...
const createAuctionHouse = (mx, auctioneerAuthority, input = {}) => __awaiter(void 0, void 0, void 0, function* () {
    const { auctionHouse } = yield mx
        .auctions()
        .createAuctionHouse(Object.assign({ sellerFeeBasisPoints: 200, auctioneerAuthority: auctioneerAuthority === null || auctioneerAuthority === void 0 ? void 0 : auctioneerAuthority.publicKey }, input))
        .run();
