...
(0, tape_1.default)('[candyMachineModule] create with SPL treasury', (t) => __awaiter(void 0, void 0, void 0, function* () {
    // Given a Candy Machine client.
    ...
    const { response, candyMachine } = yield client
        .create(Object.assign(Object.assign({}, minimalInput), { wallet: token.address, tokenMint: token.mint.address }))
        .run();
    ...
    (0, spok_1.default)(t, candyMachine, {
        $topic: 'Candy Machine',
        model: 'candyMachine',
        walletAddress: (0, helpers_1.spokSamePubkey)(token.address),
        tokenMintAddress: (0, helpers_1.spokSamePubkey)(token.mint.address),
    });
}));
