...
import { FindListingByReceiptInput } from './findListingByReceipt';
import { FindListingByTradeStateInput } from './findListingByTradeState';
...
export declare class AuctionHouseClient {
    ...
    findListingByTradeState(tradeStateAddress: PublicKey, options?: Omit<FindListingByTradeStateInput, 'tradeStateAddress' | 'auctionHouse'>): Task<Readonly<{
        model: "listing";
        lazy: false;
        auctionHouse: AuctionHouse;
        asset: import("..").SftWithToken | import("..").NftWithToken;
    ...
    findListingByReceipt(receiptAddress: PublicKey, options?: Omit<FindListingByReceiptInput, 'receiptAddress' | 'auctionHouse'>): Task<Readonly<{
        model: "listing";
        lazy: false;
        auctionHouse: AuctionHouse;
        asset: import("..").SftWithToken | import("..").NftWithToken;
