...
var findListingByReceipt = require('./findListingByReceipt.cjs');
var findListingByTradeState = require('./findListingByTradeState.cjs');
...
class AuctionHouseClient {
  ...
  findListingByTradeState(tradeStateAddress, options = {}) {
    return this.metaplex.operations().getTask(findListingByTradeState.findListingByTradeStateOperation({
      tradeStateAddress,
      auctionHouse: this.auctionHouse,
      ...options
    }));
  ...
  findListingByReceipt(receiptAddress, options = {}) {
    return this.metaplex.operations().getTask(findListingByReceipt.findListingByReceiptOperation({
      receiptAddress,
      auctionHouse: this.auctionHouse,
      ...options
    }));
